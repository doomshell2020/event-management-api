...
module.exports = {
  ...
  User, Package, PackageDetails, TicketPricing, EventSlots, Cart, Orders, Wellness, WellnessSlots,ContactUs,Seo,Templates,
  Currency, Payment, PaymentSnapshotItems, CommitteeMembers, CommitteeAssignTickets,CommitteeGroup,CommitteeGroupMember,Static
};